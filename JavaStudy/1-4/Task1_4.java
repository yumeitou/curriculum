...
public class Task1_4 {
    ...
    // 定数（メッセージ）
    private static final String CONST_MSG_SUCCESS = "success";
    private static final String CONST_MSG_ERROR_NAME = "Wrong name";
    private static final String CONST_MSG_ERROR_PASS = "Wrong password";
    private static final String CONST_MSG_ERROR_INPUT = "The information you entered is incorrect.";
